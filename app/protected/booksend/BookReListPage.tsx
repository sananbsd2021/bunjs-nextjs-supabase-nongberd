...
const BookSendListPage = () => {
  ...
  return (
    <div className="container p-4">
      <h1 className="text-2xl font-bold mb-4">ทะเบียนส่งหนังสือ</h1>
          ...
          <table className="min-w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-4 py-2">เลขทะเบียนส่ง</th>
            ...
            <tbody>
              {posts.map((post) => (
                <tr key={post.id} className="text-center">
                  <td className="border border-gray-300 px-4 py-2">{post.numsend}</td>
                  <td className="border border-gray-300 px-4 py-2">{post.date}</td>
                  <td className="border border-gray-300 px-4 py-2">{post.fromsend}</td>
                  <td className="border border-gray-300 px-4 py-2">{post.tosend}</td>
                  ...
                  <td>
                  <Link href={`/protected/booksend/${post.id}`} className="px-4 py-2 bg-gray-600 text-white rounded">View</Link>
                </td>
                </tr>
              ))}
            </tbody>
...
export default BookSendListPage;
