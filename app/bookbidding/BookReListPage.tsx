            ...
            <tbody>
              {posts.map((post) => (
                <tr key={post.id} className="text-center">
                  <td className="border border-gray-300 px-4 py-2">{post.numbid}</td>
                  <td className="border border-gray-300 px-4 py-2">{post.date}</td>
                  <td className="border border-gray-300 px-4 py-2">{post.frombid}</td>
                  {/* <td className="border border-gray-300 px-4 py-2">{post.tobid}</td> */}
